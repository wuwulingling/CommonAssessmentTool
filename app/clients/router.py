...
@router.get("/{client_id}/services", response_model=List[ServiceResponse])  # Changed to List
...
async def update_client_services(
    ...
    """Update services provided by a specific case worker for a specific client"""
